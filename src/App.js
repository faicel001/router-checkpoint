...
function App() {
  const movies = [
    ...
    { title: "Long Story Short", description: "Serial procrastinator Teddy (Rafe Spall) wakes up the morning after his wedding to discover that every few minutes he's jumping forward to the next year of his life. Watching his future flash before his eyes, Teddy must make every second count if he is to win back the woman he loves in this feel good comedy about second chances.", rate: 5.4, posturl: "https://upload.wikimedia.org/wikipedia/en/5/5e/Long_story_short.jpg",trai:<iframe width="560" height="315" src="https://www.youtube.com/embed/AABncEkIluM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> },
